...
def convert_to_ppt(input_path: str, output_path: Path, enable_stage2: bool = False) -> None:
    ...
    if source.suffix.lower() == ".pdf":
        ...
        for index in range(page_count):
            ...
            # Extract native PDF text (with RENDER_SCALE correction);
            # falls back to OCR on rendered image for image-based PDFs.
            ...
            # Hybrid strategy: rendered page image as background for visual
            # fidelity; native text overlaid as editable text boxes.
            # No diagram extraction — diagrams are already in the background.
